...
class DropletController(appier.Controller):
    ...
    def list(self):
        return self.template("droplet/list.html.tpl", link="droplets")
    ...
    def do_config(self, id):
        ...
        return self.redirect(self.url_for("droplet.show", id=id))
    ...
    def create_provision(self, id):
        ...
        return self.redirect(self.url_for("provision.log", pid=provision.pid))
    ...
    def sync(self, id):
        ...
        return self.redirect(
            self.url_for("droplet.show", id=id, message="Sync successful")
        )
